\hypertarget{usb-gui_8c}{
\section{usb-\/gui.c File Reference}
\label{usb-gui_8c}\index{usb-\/gui.c@{usb-\/gui.c}}
}
...
void \hyperlink{usb-gui_8c_ad870b459afa4a0b65382e4bb1a57ae10}{fatal\_\-error\_\-signal} (int sig)
\begin{DoxyCompactList}\small\item\em handler for exceptions. \item\end{DoxyCompactList}\item 
void \hyperlink{usb-gui_8c_aafc00ee8c683e0173f3e064fcefd10a2}{add\_\-item} (GtkWidget $\ast$widget, GdkEvent $\ast$event, gpointer data)
\begin{DoxyCompactList}\small\item\em Add a item to treeview. \item\end{DoxyCompactList}\item 
gchar $\ast$ \hyperlink{usb-gui_8c_a4cc20d1f244d51683a95232429734aca}{get\_\-new\_\-device\_\-id} ()
\begin{DoxyCompactList}\small\item\em Get a identify new for a row. \item\end{DoxyCompactList}\end{DoxyCompactItemize}
\subsection*{Variables}
\begin{DoxyCompactItemize}
\item 
\hypertarget{usb-gui_8c_a6d4b8b8c6be4c4a8bb0d89f8a40324c4}{
volatile sig\_\-atomic\_\-t \hyperlink{usb-gui_8c_a6d4b8b8c6be4c4a8bb0d89f8a40324c4}{fatal\_\-error\_\-in\_\-progress} = 0}
\label{usb-gui_8c_a6d4b8b8c6be4c4a8bb0d89f8a40324c4}
...
\item[Enumerator: ]\par
\begin{description}
\index{COLUMN\_\-MARKED@{COLUMN\_\-MARKED}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!COLUMN\_\-MARKED@{COLUMN\_\-MARKED}}\item[{\em 
...
}]indicate if is marked (Value = 0) \index{COLUMN\_\-ID@{COLUMN\_\-ID}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!COLUMN\_\-ID@{COLUMN\_\-ID}}\item[{\em 
...
}]identifier (Value = 1) \index{COLUMN\_\-SERIAL@{COLUMN\_\-SERIAL}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!COLUMN\_\-SERIAL@{COLUMN\_\-SERIAL}}\item[{\em 
...
}]serial number (Valued = 2) \index{NUM\_\-COLUMNS@{NUM\_\-COLUMNS}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!NUM\_\-COLUMNS@{NUM\_\-COLUMNS}}\item[{\em 
...
\hypertarget{usb-gui_8c_a4a517367fd55e0e2fab7fa26d5f6cc57}{
\index{usb-\/gui.c@{usb-\/gui.c}!\_\-\_\-type\_\-action@{\_\-\_\-type\_\-action}}
\index{\_\-\_\-type\_\-action@{\_\-\_\-type\_\-action}!usb-gui.c@{usb-\/gui.c}}
...
\item[Enumerator: ]\par
\begin{description}
\index{AUTHORIZE@{AUTHORIZE}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!AUTHORIZE@{AUTHORIZE}}\item[{\em 
...
}]AUTHORIZE. \index{UNAUTHORIZE@{UNAUTHORIZE}!usb-\/gui.c@{usb-\/gui.c}}\index{usb-\/gui.c@{usb-\/gui.c}!UNAUTHORIZE@{UNAUTHORIZE}}\item[{\em 
...
\index{usb-\/gui.c@{usb-\/gui.c}!add\_\-item@{add\_\-item}}
\index{add\_\-item@{add\_\-item}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!authorize\_\-device@{authorize\_\-device}}
\index{authorize\_\-device@{authorize\_\-device}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!do\_\-list\_\-store@{do\_\-list\_\-store}}
\index{do\_\-list\_\-store@{do\_\-list\_\-store}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!fatal\_\-error\_\-signal@{fatal\_\-error\_\-signal}}
\index{fatal\_\-error\_\-signal@{fatal\_\-error\_\-signal}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!get\_\-new\_\-device\_\-id@{get\_\-new\_\-device\_\-id}}
\index{get\_\-new\_\-device\_\-id@{get\_\-new\_\-device\_\-id}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!main@{main}}
\index{main@{main}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!read\_\-devices\_\-list@{read\_\-devices\_\-list}}
\index{read\_\-devices\_\-list@{read\_\-devices\_\-list}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!remove\_\-item@{remove\_\-item}}
\index{remove\_\-item@{remove\_\-item}!usb-gui.c@{usb-\/gui.c}}
...
\index{usb-\/gui.c@{usb-\/gui.c}!update\_\-tool\_\-bar@{update\_\-tool\_\-bar}}
\index{update\_\-tool\_\-bar@{update\_\-tool\_\-bar}!usb-gui.c@{usb-\/gui.c}}
